    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                isAnNumber = int.TryParse(Console.ReadLine(), out userInput);
            } while (isAnNumber == false);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"The number you typed is on our list");
            }
            else
            {
                Console.WriteLine($"The number you typed is not on our list");
            }
        }
